...
export default function ChatWindow() {
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: "Hi! I'm your AI shopping assistant powered by Spring AI with function calling. I can search your product catalog in real time. What are you looking for?",
    },
  ])
